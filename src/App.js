...
function NonMagic() {
  // let answers = ["Спроси меня о чем-нибудь", "Дай подумать.."];
    ...
    <div className="App">
      <main className="App-header">
        ...
        <div className='uk-width-1-3 uk-text-muted uk-text-meta'>
          {/* <p>Задайте вопрос, вслух или мысленно, и нажмите на кнопку. Если же вы хотите написать вопрос, вы можете сделать это здесь:</p> */}
        ...
        <div className='uk-flex'>
          {/* <input className='uk-input uk-button-secondary uk-text-muted uk-text-meta' type="text" name="" placeholder='Спроси что угодно...'/> */}
          <input className='uk-input uk-button-secondary uk-text-muted uk-text-meta' type="text" name="" placeholder='You can ask anything..'/>
          {/* <input className='uk-button uk-button-primary' type="button" value="Спросить" onClick={() => setCount(count + 1)}/> */}
